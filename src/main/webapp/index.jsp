...
<%--    <a href="adminRegistration.html" style="color:white; font-family:'Times New Roman, Times, serif'; padding-top:12px;"> new Admin ?? register here</a><br><br>--%>
    <a href ="teacherRegistration.html" style="color:white; font-family:'Times New Roman, Times, serif'; padding-top:12px;"> for teacher register here</a><br><br>
    <a href="studentRegistration.html" style="color:white; font-family:'Times New Roman, Times, serif'; padding-top:12px;">for student register here</a><br><br>
</div>
</body>
