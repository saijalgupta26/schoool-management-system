...
<div class="login-box">
  <h2>Login</h2>
  <form action="Teacher?action=login" method="post">
    <div class="user-box">
  ...
  <a href="teacherLogin.jsp" style="color:white; font-family:'Times New Roman, Times, serif'; padding-top:12px;"> new user ?? register here</a><br><br>
</div>
</body>
