...
<table class="table">
    ...
    <tr>
        ...
        <td><a href="Teacher?action=delete&username=<%= students.get(i).getUsername()%>">delete</a></td>
        <td><a href="Teacher?action=update&username=<%= students.get(i).getUsername()%>">update</a></td>
